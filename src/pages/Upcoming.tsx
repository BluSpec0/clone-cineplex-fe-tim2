  ...
  return (
    <><div className=" object-top  w-full bg-white h-[110px] p-6 border-b">
      ...
      <div className="pt-10 pl-32">
        <a href="#">
          <Image
          src="https://media.21cineplex.com/webcontent/gallery/pictures/167929992845095_211x310.jpg"
          alt=""
          height={303}
          width={211}
          style={{ margin: "5rem 0rem 2rem 0rem" }}></Image>
        </a>
        <a href="#">
          <Image
          src="https://media.21cineplex.com/webcontent/gallery/pictures/167940129665718_211x310.jpg"
          alt=""
          height={303}
          width={211}
          style={{ margin: "-20.9rem 0rem 2rem 15rem" }}></Image>
        </a>
        <a href="#">
          <Image
          src="https://media.21cineplex.com/webcontent/gallery/pictures/16790447508009_211x310.jpg"
          alt=""
          height={303}
          width={211}
          style={{ margin: "-21rem 0rem 2rem 30rem" }}></Image>
        </a>
        <a href="#">
          <Image
          src="https://media.21cineplex.com/webcontent/gallery/pictures/167888119464626_211x310.jpg"
          alt=""
          height={303}
          width={211}
          style={{ margin: "-21rem 0rem 2rem 45rem" }}></Image>
        </a>  
        <Text weight={500} size={14}>
          <p style={{margin: "-1.2rem 0rem 0rem 4.7rem"}}>Khanzab</p>
          <p style={{margin: "-1.4rem 0rem 0rem 19.4rem"}}>Sewu Dino</p>
          <p style={{margin: "-1.4rem 0rem 0rem 35rem"}}>Ride On</p>
          <p style={{margin: "-1.3rem 0rem 0rem 49.9rem"}}>Jin & Jun</p>
        </Text>
      </div>
