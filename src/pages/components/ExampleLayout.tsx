...
const ExampleLayout = ({ children }: any) => {
  return (
    <>
      ...
      <div className="mt-20 ml-36 w-40 bg-teal-800 text-gray-100 text-center pb-1.5 pt-0.5 font-bold tracking-widest">
        <p>Now Playing</p>
      </div>

      <div className=" bg-gray-100 text-teal-800 w-44 p-1"
        style={{margin: "-33px 0rem -2rem 19rem" }}>
      ...
      <div className="w-full bg-teal-800 h-[100px] pb-[48px] md:pb-0 px-2 md:px-5"></div>
    </>
  );
};
